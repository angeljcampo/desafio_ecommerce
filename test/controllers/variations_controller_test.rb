...
class VariationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variation" do
    assert_difference('Variation.count') do
      post variations_url, params: { variation: { color_id: @variation.color_id, price: @variation.price, product_id: @variation.product_id, size_id: @variation.size_id, sku: @variation.sku, stock: @variation.stock } }
    end
  ...
  test "should update variation" do
    patch variation_url(@variation), params: { variation: { color_id: @variation.color_id, price: @variation.price, product_id: @variation.product_id, size_id: @variation.size_id, sku: @variation.sku, stock: @variation.stock } }
